...
sudo apt-get install -y build-essential cmake git gfortran libatlas-base-dev libavcodec-dev \
libavformat-dev libavresample-dev libcanberra-gtk3-module libdc1394-22-dev libeigen3-dev \
libglew-dev libgstreamer-plugins-base1.0-dev libgstreamer-plugins-good1.0-dev libgstreamer1.0-dev \
libgtk-3-dev libjpeg-dev libjpeg8-dev libjpeg-turbo8-dev liblapack-dev liblapacke-dev libopenblas-dev\
libpng-dev libpostproc-dev libswscale-dev libtbb-dev libtbb2 libtesseract-dev libtiff-dev libv4l-dev\
libxine2-dev libxvidcore-dev libx264-dev pkg-config python-dev python-numpy python3-dev python3-numpy \
python3-matplotlib qv4l2 v4l-utils v4l2ucp zlib1g-dev
# 安装QT
...
# cmake 
cmake -DBUILD_EXAMPLES=OFF -DWITH_NVCUVID=ON -DWITH_QT=ON -DBUILD_opencv_python2=ON -D BUILD_opencv_python3=ON \
-D CMAKE_BUILD_TYPE=RELEASE -DCMAKE_INSTALL_PREFIX=${root_path}/build_opencv/opencv-4.4.0/install \
-D CUDA_ARCH_BIN=7.2 -D CUDA_ARCH_PTX="" -D CUDA_FAST_MATH=ON -D CUDNN_VERSION='8.0'\
-D EIGEN_INCLUDE_PATH=/usr/include/eigen3 -D ENABLE_NEON=ON -DOPENCV_DNN_CUDA=ON \
-DOPENCV_ENABLE_NONFREE=ON -DOPENCV_EXTRA_MODULES_PATH=${root_path}/build_opencv/opencv_contrib-4.4.0/modules \
-DOPENCV_GENERATE_PKGCONFIG=ON -D WITH_CUBLAS=ON -D WITH_CUDA=ON -D WITH_CUDNN=ON -DWITH_GSTREAMER=ON \
-D WITH_LIBV4L=ON -D WITH_OPENGL=ON -D BUILD_PERF_TESTS=OFF -D BUILD_TESTS=OFF 
